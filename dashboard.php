...
<body>
    ...
    <div class="main">
        <?php
            echo '<b><p style="color:white;">Number of classes:'.$no_of_classes[0].'</p></b>';
            echo '<b><p style="color:white;">Number of students:'.$no_of_students[0].'</p></b>';
            echo '<b><p style="color:white;">Number of results:'.$no_of_result[0].'</p></b>';
        ?>
    </div>
