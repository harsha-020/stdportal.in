    ...
    <div class="main">
        <form action="" method="post">
            ...
            <legend>Enter Marks</legend>
                ...
                <input type="text" name="p1" id="" placeholder="SUB 1">
                <input type="text" name="p2" id="" placeholder="SUB 2">
                <input type="text" name="p3" id="" placeholder="SUB 3">
                <input type="text" name="p4" id="" placeholder="SUB 4">
                <input type="text" name="p5" id="" placeholder="SUB 5">
